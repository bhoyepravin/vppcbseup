    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <motion.button
            onClick={scrollLeft}
            className="hidden lg:flex absolute -left-16 top-1/2 -translate-y-1/2 w-14 h-14 rounded-2xl bg-gradient-to-r from-[#194369] to-[#194369] text-white shadow-2xl items-center justify-center hover:from-[#194369] hover:to-[#194369] transition-all duration-300 hover:scale-110 z-20 backdrop-blur-sm border border-white/20"
            ...
            {vppLatestNewsData.items.map((item, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <a
                    href={item.link}
                    className="inline-flex items-center text-[#194369] hover:text-#194369 font-semibold text-sm group/link"
                  >
          ...
          <motion.button
            onClick={scrollRight}
            className="hidden lg:flex absolute -right-16 top-1/2 -translate-y-1/2 w-14 h-14 rounded-2xl bg-gradient-to-r from-[#194369] to-[#194369] text-white shadow-2xl items-center justify-center hover:from-[#194369] hover:to-[#194369] transition-all duration-300 hover:scale-110 z-20 backdrop-blur-sm border border-white/20"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
        ...
        >
          <a
            href="/"
            className="group px-10 py-4 bg-gradient-to-r from-[#194369] to-[#194369] text-white rounded-xl font-semibold hover:from-[#194369] hover:to-[#194369] transition-all duration-300 shadow-2xl hover:shadow-3xl hover:-translate-y-1 transform flex items-center gap-3"
          >
