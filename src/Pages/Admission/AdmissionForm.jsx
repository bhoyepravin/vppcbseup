      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="text-center pt-6">
          <button
            ...
            className="px-10 py-4 bg-[#194369] text-white text-lg font-semibold rounded-lg  transition duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
